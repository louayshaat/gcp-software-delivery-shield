...
A successful build will run through the 7 steps of building the image, scan it, passing the checks it will tag it, push it to Artifact registry, Attesting it using Binary Auth and deploying a manifest to GKE
